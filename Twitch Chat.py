...
def bar(stop_event): #The other people chatting 
        ...
        while not stop_event.is_set():
            ...
            message = [
                       'I like '+str(random.choice(random_var))+'!',
                       'This is a message!',
                       'Skateboarding is awesome!',
                       'Hola, como estas?',
                       "I don't like "+str(random.choice(thing)),
                       'nuh uh','Is this the krusty krab?',
                       'gleep glorp','haha I agree with this guy',
                       'WHAT',"Shouldn't you be working?",'stop that',
                       'I dropped out of school for this stream',
                       ...
                       'hey your shoe is untied','NO ITS NOT',
                       'Im tired',
                       ...
                       "I'd die, honestly",
                       'Would you still love me if I was a '+str(random.choice(food))+'?',
